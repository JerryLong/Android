...
public class ViewFind {
	// 使用
	// ViewFind finder = new ViewFind(this);
	// TextView title = finder.find(R.id.textView1);
	// title.setText("text");
	 ...
	 * @param view
	 */
	public ViewFind(final View view) {
	 ...
	 * @param window
	 */
	public ViewFind(final Window window) {
	 ...
	 * @param activity
	 */
	public ViewFind(final Activity activity) {
